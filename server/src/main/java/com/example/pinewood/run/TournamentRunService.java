...
import com.example.pinewood.algo.*;
...
public class TournamentRunService {
    ...
    public TournamentRun startRun(String tournamentId) {
        ...
        laneCount track = configService.getTrack(tc.getTrackConfigId())
    ...
    private static class RunContext {
        ...
        RunContext(TournamentConfig t, laneCount track, List<Racer> racers, TournamentAlgorithm algo) {
